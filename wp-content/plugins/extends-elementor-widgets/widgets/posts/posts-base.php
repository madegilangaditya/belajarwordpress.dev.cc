<?php
// namespace ExtendsEle\Widgets\Posts;
require_once('traits/button-widget-trait.php');
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'classic',
                'options' => [
                    'classic' => __( 'Classic', 'demo-starter' ),
                    'card' => __( 'Card', 'demo-starter' ),
                    'full' => __( 'Full Width', 'demo-starter' ),
                ],
            ]
        );
